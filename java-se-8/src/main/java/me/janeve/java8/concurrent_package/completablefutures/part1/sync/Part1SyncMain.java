package me.janeve.java8.concurrent_package.completablefutures.part1.sync;

import com.google.gson.Gson;
import com.google.gson.JsonSyntaxException;
import me.janeve.java8.concurrent_package.completablefutures.part1.entities.TransactionData;
import me.janeve.java8.concurrent_package.completablefutures.part1.sync.executors.SynchronousExecution;
import me.janeve.java8.helpers.Timer;

public class Part1SyncMain {
    ...
    public static void main(String[] args) {
        ...
        for(TransactionData payload: payloads) {
            System.out.println("Result: " + new SynchronousExecution().fetchTransactionDetails(payload));
        }
        Timer.stop("MAIN");
    }
